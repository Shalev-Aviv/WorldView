...
import { southAmericanCountries } from "../data/countries";
...
const SouthAmericaMap: React.FC<SouthAmericaMapProps> = ({
  selectedCountryName,
  visitedCountries,
  onCountryClick,
}) => (
  <div>
    <svg
      ...
      className="stroke-black stroke-[0.2px] fill-white w-[614px] h-[1001px]"

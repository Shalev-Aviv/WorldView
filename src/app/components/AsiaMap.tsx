...
const AsiaMap: React.FC<AsiaMapProps> = ({ selectedCountryName, visitedCountries, onCountryClick }) => (

    <div>
        <svg xmlns="http://www.w3.org/2000/svg"
            version="1.2" id="svg2"
            style={{ strokeLinejoin: 'round' }}
            className='stroke-black stroke-[0.2px] fill-white w-[1256px] h-[1001px]'
